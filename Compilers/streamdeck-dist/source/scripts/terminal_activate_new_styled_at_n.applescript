-- START OF FILE: terminal_activate_new_styled_at_n.txt (from your initial prompt)
-- Purpose: Handles @N buttons. Forces a new styled window and executes the command.
...
-- END OF FILE: terminal_activate_new_styled_at_n.txt