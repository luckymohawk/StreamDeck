-- START OF FILE: terminal_command_to_active_at_device.txt (from your initial prompt - you said this version works)
-- Purpose: Sends a command to an already existing, active @-device window using keystrokes.
...
-- END OF FILE: terminal_command_to_active_at_device.txt