-- START OF FILE: terminal_do_script_default.txt (from your initial prompt)
-- Purpose: Default command execution in Terminal.
...
-- END OF FILE: terminal_do_script_default.txt